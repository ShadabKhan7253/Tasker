...
import { AppBar, Toolbar, Typography, Card, TextField, Button, Container, Grid, List, ListItem, ListItemText, ListItemSecondaryAction, Checkbox, Chip } from '@mui/material';
                ...
                <Grid container justifyContent="center" sx={{ marginTop: 4 }}>
                    <Grid item xs={12}>
                        <Card sx={{ padding: 1 }} raised='true'>
                            <List sx={{ padding: 1}}>
                              <ListItem key={1} sx={{ paddingBottom: 2, paddingTop: 2, borderBottom: 'solid 1px #AAA' }} disablePadding>
                              ...
                              <ListItem key={2} disablePadding sx={{ paddingBottom: 2, paddingTop: 2, borderBottom: 'solid 1px #AAA' }}>
                                <Checkbox />
